#' Functional Data Analysis and Utilities for Statistical Computing (fda.usc.devel)
#' 
...
#' 
#' Sections of fda.usc.devel-package: \cr 
#' \tabular{ll}{ 
...
#' 
#' \tabular{ll}{ Package: \tab fda.usc.devel\cr Type: \tab Package\cr Version: \tab
#' 2.0.4\cr Date: \tab 2021-03-29\cr License: \tab GPL-2 \cr LazyLoad: \tab
#' yes\cr Url: \url{https://github.com/moviedo5/} }
#' 
#' @name fda.usc.devel-package
#' @aliases fda.usc.devel-package fda.usc.devel
#' @docType package
...
#'   STAPH group maintaining the page \url{https://www.jstatsoft.org/v51/i04/}
#' 
